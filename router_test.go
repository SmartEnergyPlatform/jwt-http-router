...
func TestRouterAPI(t *testing.T) {
	...
	router := New(JwtConfig{})
	router.GET("/GET", func(w http.ResponseWriter, r *http.Request, _ Params, jwt Jwt) {
		get = true
	})
	router.HEAD("/GET", func(w http.ResponseWriter, r *http.Request, _ Params, jwt Jwt) {
		head = true
	})
	router.OPTIONS("/GET", func(w http.ResponseWriter, r *http.Request, _ Params, jwt Jwt) {
		options = true
	})
	router.POST("/POST", func(w http.ResponseWriter, r *http.Request, _ Params, jwt Jwt) {
		post = true
	})
	router.PUT("/PUT", func(w http.ResponseWriter, r *http.Request, _ Params, jwt Jwt) {
		put = true
	})
	router.PATCH("/PATCH", func(w http.ResponseWriter, r *http.Request, _ Params, jwt Jwt) {
		patch = true
	})
	router.DELETE("/DELETE", func(w http.ResponseWriter, r *http.Request, _ Params, jwt Jwt) {
		delete = true
	})
...
func TestRouterChaining(t *testing.T) {
	router1 := New(JwtConfig{})
	router2 := New(JwtConfig{})
	router1.NotFound = router2

	fooHit := false
	router1.POST("/foo", func(w http.ResponseWriter, req *http.Request, _ Params, jwt Jwt) {
		fooHit = true
		w.WriteHeader(http.StatusOK)
	})

	barHit := false
	router2.POST("/bar", func(w http.ResponseWriter, req *http.Request, _ Params, jwt Jwt) {
		barHit = true
		w.WriteHeader(http.StatusOK)
	})
...
func TestRouterOPTIONS(t *testing.T) {
	handlerFunc := func(_ http.ResponseWriter, _ *http.Request, _ Params, jwt Jwt) {}
	...
	// custom handler
	var custom bool
	router.OPTIONS("/path", func(w http.ResponseWriter, r *http.Request, _ Params, jwt Jwt) {
		custom = true
	})
...
func TestRouterPanicHandler(t *testing.T) {
	...
	router.Handle("PUT", "/user/:name", func(_ http.ResponseWriter, _ *http.Request, _ Params, jwt Jwt) {
		panic("oops!")
	})
...
func TestRouterLookup(t *testing.T) {
	routed := false
	wantHandle := func(_ http.ResponseWriter, _ *http.Request, _ Params, jwt Jwt) {
		routed = true
	}
